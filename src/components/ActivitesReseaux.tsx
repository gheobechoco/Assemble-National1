...
const activites: ActiviteReseau[] = [
  {
    titre: "Conférence du Réseau des Femmes Parlementaires sur l'autonomisation",
    description: "Échanges sur les stratégies législatives pour l'égalité des genres.",
    date: "18 Mai 2024",
    reseau: "Réseau des Femmes Parlementaires",
    image: "https://placehold.co/400x200/e0e0e0/333333?text=Femmes+Parl"
  },
  {
    titre: "Atelier du Réseau des Jeunes Parlementaires sur l'innovation",
    description: "Exploration des nouvelles technologies et de leur impact sur la législation.",
    date: "01 Avril 2024",
    reseau: "Réseau des Jeunes Parlementaires",
    image: "https://placehold.co/400x200/e0e0e0/333333?text=Jeunes+Parl"
  },
  {
    titre: "Table ronde du Réseau Parlementaires pour l'Environnement",
    description: "Débat sur les mesures d'adaptation et d'atténuation du changement climatique.",
    date: "10 Mars 2024",
    reseau: "Réseau des Parlementaires pour l'Environnement",
    image: "https://placehold.co/400x200/e0e0e0/333333?text=Parl+Environnement"
  },
];
...
const ActivitesReseaux: React.FC<ActivitesReseauxProps> = ({ navigateTo }) => {
        ...
        <div className="w-full lg:w-9/12 px-4">
          ...
          <nav className="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
            <ol className="list-none p-0 inline-flex">
              ...
              <li className="flex items-center">
                <span className="text-gray-900">Activités des Réseaux</span>
              </li>
            </ol>
          </nav>

          <h1 className="text-3xl font-bold text-gray-800 mb-8 font-serif">Activités des Réseaux Interparlementaires</h1>

          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 mb-8">
            <p className="text-lg text-gray-700 mb-6">
              Retrouvez ici les dernières activités et initiatives des différents réseaux interparlementaires auxquels l'Assemblée Nationale du Gabon participe.
            </p>
...
export default ActivitesReseaux;
