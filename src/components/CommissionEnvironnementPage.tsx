// src/components/CommissionEnvironnementPage.tsx
...
// Images spécifiques pour le bureau de la commission de l'environnement (basées sur les captures d'écran)
const commissionEnvironnementBureauImages: { [key: string]: string } = {
  "Paul BIYOGHE MBA": "https://placehold.co/150x150/e0e0e0/333333?text=P.B.+MBA", // Image de Paul BIYOGHE MBA
  "NGUEMA NGUEMA Sosthène": "https://placehold.co/150x150/e0e0e0/333333?text=S.+NGUEMA", // Image de NGUEMA NGUEMA Sosthène
  "NGOUENEMI NDZEGOUMA": "https://placehold.co/150x150/e0e0e0/333333?text=N.+NDZEGOUMA", // Image de NGOUENEMI NDZEGOUMA
  "ADIABENOT MEPOREWA Flavienne Patricia Hélène": "https://placehold.co/150x150/e0e0e0/333333?text=F.P.H.+ADIABENOT", // Image de ADIABENOT MEPOREWA Flavienne Patricia Hélène
  "BOUKANDOU Elza-Richtuelle": "https://placehold.co/150x150/e0e0e0/333333?text=E.+BOUKANDOU", // Image de BOUKANDOU Elza-Richtuelle
  "MIHINDOU MI-NZAMBA Carl": "https://placehold.co/150x150/e0e0e0/333333?text=C.+MIHINDOU", // Image de MIHINDOU MI-NZAMBA Carl
};

// Données des membres du bureau de la commission de l'environnement

// Liste complète des membres de la commission de l'environnement (basée sur les captures d'écran et complétée)
const allCommissionEnvironnementMembers = [
  "BIYOGHE MBA Paul", "NGUEMA NGUEMA Sosthène", "NGOUENEMI NDZEGOUMA", "ADIABENOT-MEPOREWA Flavienne Patricia Hélène",
  "BOUKANDOU Elza Richtuelle", "MIHINDOU MI-NZAMBA Carl", "ABIERY WILLY BERTRAND", "ABOUGHE OTSAGHE Charlotte",
  "AKOMEZOCHO FRANCOIS AUGUSTE", "AKURE DAVAIN Séraphin", "BANDEGA LENDOYE Raphaël", "BECKOPA EPSE Roy Valentin Virginie",
  "BEKA B'OBAME Jean Marie", "BOUANGA MOMBO ep. MAKITA Nicole", "BOUYOU Tatiana Mireille", "DIOUMY MOUBASSANGO Donatien Lhye",
  "DOUMBENENY Jean Lucien", "EBANETH EP. SIMA EYI NATHALIE", "EKOUA SIMA Jean Paulin", "ELLA ENGONGA Leonel",
  "ELLA NGUEMA Gerard", "EYEGHE Ali", "FOUMBOULA LIBEKA M. GEOFFROY", "GEY Charles-Henri",
  "GONDJOUT INDJENDJET Melvin Vincent", "IDODO Jean Lambert", "IMMONGUALT TATANGANI Eudes Régis", "ISSEMBE Serge Aimé",
  "KOUMBA Brigitte", "LEYAMA Jean Valentin", "LIBAMA Marcel", "LISSENGUET GOUMBOU Irène",
  "MABIALA Serge Maurice", "MAGANGA MOUSSAVOU née MALANDOU BOUKA Albertine", "MALLY HODJOUA Gabriel", "MANDJOU NGAYOUO Paulin",
  "MBADINGA MBADINGA Josué", "MBAGOU Jean-Bosco", "MBAGOU Jeanne", "MENIE M'YEYI Antoine",
  "MENGUE EKOMIE Roger", "MOUELE ROMAIN ROMAIN", "MOUITY MOUNDOUNGA Patrice", "MOURI BOUSSOUGOU Dieudonné",
  "MOUSSAVOU Florentin", "NDIMAL BARRY Marcellin", "NDJIMBI Franck", "NDONG OBIANG François",
  "NGABIKOUMOU WADA Mesmin Boris", "NGOMA Angélique", "NGUIENO Dominique Guy-Noël", "NTOUTOUME Béatrice",
  ...
  "YEMBIT MANGALA Jean de Dieu"
];


const CommissionEnvironnementPage: React.FC = () => {
      ...
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full md:w-9/12 px-4">
          ...
          <h2 className="text-3xl font-bold text-blue-800 mb-6 pb-2 border-b-2 border-blue-500">
            Le Bureau de la Commission de l'Environnement, du Climat, de la Protection de la Nature et du Développement Durable
          </h2>
          ...
          <div className="flex flex-col items-center justify-center space-y-8 mb-12">
            ...
            <div className="text-center">
              <img
                src={commissionEnvironnementBureauImages["Paul BIYOGHE MBA"]}
                alt="Paul BIYOGHE MBA"
              ...
              />
              <p className="text-gray-800 font-semibold text-lg">Paul BIYOGHE MBA</p>
            ...
            <div className="flex flex-wrap justify-center gap-8 w-full">
              <div className="text-center w-48">
                <img
                  src={commissionEnvironnementBureauImages["NGUEMA NGUEMA Sosthène"]}
                  alt="NGUEMA NGUEMA Sosthène"
                ...
                />
                <p className="text-gray-800 font-semibold text-base">NGUEMA NGUEMA Sosthène</p>
                <p className="text-gray-600 text-xs">1er Vice-Président</p>
              </div>
              <div className="text-center w-48">
                <img
                  src={commissionEnvironnementBureauImages["NGOUENEMI NDZEGOUMA"]}
                  alt="NGOUENEMI NDZEGOUMA"
                  className="rounded-full mx-auto mb-2 w-28 h-28 object-cover border-2 border-blue-500 shadow-lg"
                  onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/e0e0e0/333333?text=2eme+VP"; }}
                />
                <p className="text-gray-800 font-semibold text-base">NGOUENEMI NDZEGOUMA</p>
            ...
            <div className="flex flex-wrap justify-center gap-8 w-full">
              <div className="text-center w-48">
                <img
                  src={commissionEnvironnementBureauImages["ADIABENOT MEPOREWA Flavienne Patricia Hélène"]}
                  alt="ADIABENOT MEPOREWA Flavienne Patricia Hélène"
                  className="rounded-full mx-auto mb-2 w-28 h-28 object-cover border-2 border-blue-500 shadow-lg"
                  onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/e0e0e0/333333?text=1er+Rapporteur"; }}
                />
                <p className="text-gray-800 font-semibold text-base">ADIABENOT MEPOREWA Flavienne Patricia Hélène</p>
                <p className="text-gray-600 text-xs">1er Rapporteur</p>
              </div>
              <div className="text-center w-48">
                <img
                  src={commissionEnvironnementBureauImages["BOUKANDOU Elza-Richtuelle"]}
                  alt="BOUKANDOU Elza-Richtuelle"
                  className="rounded-full mx-auto mb-2 w-28 h-28 object-cover border-2 border-blue-500 shadow-lg"
                  onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/e0e0e0/333333?text=2eme+Rapporteur"; }}
                />
                <p className="text-gray-800 font-semibold text-base">BOUKANDOU Elza-Richtuelle</p>
                <p className="text-gray-600 text-xs">2ème Rapporteur</p>
              </div>
              <div className="text-center w-48">
                <img
                  src={commissionEnvironnementBureauImages["MIHINDOU MI-NZAMBA Carl"]}
                  alt="MIHINDOU MI-NZAMBA Carl"
                  className="rounded-full mx-auto mb-2 w-28 h-28 object-cover border-2 border-blue-500 shadow-lg"
                  onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/150x150/e0e0e0/333333?text=3eme+Rapporteur"; }}
                />
                <p className="text-gray-800 font-semibold text-base">MIHINDOU MI-NZAMBA Carl</p>
          ...
          <h2 className="text-3xl font-bold text-blue-800 mb-6 pb-2 border-b-2 border-blue-500">
            Les membres de la Commission de l'Environnement, du Climat, de la Protection de la Nature et du Développement Durable
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-y-2 gap-x-4 text-gray-700">
            {allCommissionEnvironnementMembers.map((member, index) => (
...
export default CommissionEnvironnementPage;
