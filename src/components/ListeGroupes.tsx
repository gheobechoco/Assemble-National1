// src/components/ListeGroupes.tsx
...
const ListeGroupes: React.FC<ListeGroupesProps> = ({ navigateTo }) => {
        ...
        <div className="w-full lg:w-9/12 px-4">
          ...
          <nav className="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
            <ol className="list-none p-0 inline-flex">
              ...
              <li className="flex items-center">
                <span className="text-gray-900">Liste des Groupes</span>
              </li>
            </ol>
          </nav>

          <h1 className="text-3xl font-bold text-gray-800 mb-8 font-serif">Liste des Groupes d'Amitié</h1>
